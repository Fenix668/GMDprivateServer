...
$demonlistTitleURL = "";
$linkTitleURL = "";
$originalDiffColor = false; // BUG: if you leave the value of $successColor blank, $originalDiffColor is enabled after being set to 'true'
$successColor = ""; // Recommended - BBFFBB
$failColor = "FFBBBB";
$pendingColor = "FFCCBB";
$dailyColor = "FF9999";
$weeklyColor = "CACACA";
